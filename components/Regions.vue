    ...
    <div class="w-auto xl:w-28 text-left lg:text-right shrink-0 group/show">
      ...
      >
        <div 
          ...
          :class="{'lg:text-brand-navy lg:hover:bg-opacity-60': theme === 'header-light' }"
        >
        ...
        <ul
          class="nav-sub lg:shadow-xl lg:absolute z-10 right-0 top-[42px] w-[256px] bg-brand-navy rounded-lg py-0 lg:py-3 pl-2 lg:pl-0 mb-2 lg:mb-0 lg:group-hover/show:block"
